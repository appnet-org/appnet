...
class CodeGenerator(Visitor):
    ...
    def visitCreateTableStatement(self, node: CreateTableStatement, ctx: Context) -> None:
        ...
        rust_struct = RustStructType(struct_name, [trans_col_rust(i) for i in node.columns])
        table = Table(table_name, [trans_col(table_name, i) for i in node.columns], rust_struct)
        #print(rust_struct)
